...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        if (!empty($this->role)) {
			// remove old assignment role
			$astab = \yii::$app->authManager->assignmentTable;
			\Yii::$app->db->createCommand("delete from {$astab} WHERE user_id={$this->id}")
				->execute();
	...
	public function getRole() {
		return $this->hasOne(Role::className(), ['id' => 'item_id'])
            ->viaTable(\yii::$app->authManager->assignmentTable, ['name' => 'name']);
	}
}
